    ...
    const gfxc::Camera* camera, const transform2D::ViewportSpace& viewport_space)
{
    ...
    int location = glGetUniformLocation(program_id, "Model");
    ...
    location = glGetUniformLocation(program_id, "View");
    ...
    location = glGetUniformLocation(program_id, "Projection");
    ...
    location = glGetUniformLocation(program_id, "time");
