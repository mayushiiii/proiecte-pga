...
void Lab08::Update(float deltaTimeSeconds)
{
...

    {
        ...
        RenderSimpleMesh(meshes["box"], shaders["Mix"], modelMatrix, mapTextures["striped"], mapTextures["crate"]);
    }
...

    {
        ...
        RenderSimpleMesh(meshes["plane"], shaders["Ground"], modelMatrix, mapTextures["ground"], mapTextures["noise"]);
    }

    {
        ...
        modelMatrix = glm::translate(modelMatrix, glm::vec3(0, 0.1, 15));
        modelMatrix = glm::scale(modelMatrix, glm::vec3(0.3f));
        RenderSimpleMesh(meshes["plane"], shaders["Bonus"], modelMatrix, mapTextures["ground"], mapTextures["noise"]);
    }
}
